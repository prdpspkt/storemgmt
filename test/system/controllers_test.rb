...
class ControllersTest < ApplicationSystemTestCase
  ...
  test "creating a Controller" do
    ...
    fill_in "Demand form", with: @controller.demand_form
    fill_in "Mark as final", with: @controller.mark_as_final
    fill_in "Purchase order", with: @controller.purchase_order
