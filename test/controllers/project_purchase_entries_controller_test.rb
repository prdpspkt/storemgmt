...
class ProjectPurchaseEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_purchase_entry" do
    assert_difference('ProjectPurchaseEntry.count') do
      post project_purchase_entries_url, params: { project_purchase_entry: { entry_date: @project_purchase_entry.entry_date, entry_no: @project_purchase_entry.entry_no, fiscal_year_id: @project_purchase_entry.fiscal_year_id, fy: @project_purchase_entry.fy, office_chief_designation: @project_purchase_entry.office_chief_designation, office_chief_name: @project_purchase_entry.office_chief_name, office_chief_signed_date: @project_purchase_entry.office_chief_signed_date, office_id: @project_purchase_entry.office_id, section_chief_designation: @project_purchase_entry.section_chief_designation, section_chief_name: @project_purchase_entry.section_chief_name, section_chief_signed_date: @project_purchase_entry.section_chief_signed_date, store_cheif_sign_date: @project_purchase_entry.store_cheif_sign_date, store_chief_designation: @project_purchase_entry.store_chief_designation, store_chief_name: @project_purchase_entry.store_chief_name, user_id: @project_purchase_entry.user_id } }
    end
  ...
  test "should update project_purchase_entry" do
    patch project_purchase_entry_url(@project_purchase_entry), params: { project_purchase_entry: { entry_date: @project_purchase_entry.entry_date, entry_no: @project_purchase_entry.entry_no, fiscal_year_id: @project_purchase_entry.fiscal_year_id, fy: @project_purchase_entry.fy, office_chief_designation: @project_purchase_entry.office_chief_designation, office_chief_name: @project_purchase_entry.office_chief_name, office_chief_signed_date: @project_purchase_entry.office_chief_signed_date, office_id: @project_purchase_entry.office_id, section_chief_designation: @project_purchase_entry.section_chief_designation, section_chief_name: @project_purchase_entry.section_chief_name, section_chief_signed_date: @project_purchase_entry.section_chief_signed_date, store_cheif_sign_date: @project_purchase_entry.store_cheif_sign_date, store_chief_designation: @project_purchase_entry.store_chief_designation, store_chief_name: @project_purchase_entry.store_chief_name, user_id: @project_purchase_entry.user_id } }
