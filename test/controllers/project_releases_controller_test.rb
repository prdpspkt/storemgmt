...
class ProjectReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_release" do
    assert_difference('ProjectRelease.count') do
      post project_releases_url, params: { project_release: { fiscal_year_id: @project_release.fiscal_year_id, fy: @project_release.fy, marked_as_final: @project_release.marked_as_final, office_chief_name: @project_release.office_chief_name, office_chief_signed_date: @project_release.office_chief_signed_date, office_id: @project_release.office_id, project_id: @project_release.project_id, release_date: @project_release.release_date, release_no: @project_release.release_no, store_chief_name: @project_release.store_chief_name, store_chief_signed_date: @project_release.store_chief_signed_date, user_id: @project_release.user_id } }
    end
  ...
  test "should update project_release" do
    patch project_release_url(@project_release), params: { project_release: { fiscal_year_id: @project_release.fiscal_year_id, fy: @project_release.fy, marked_as_final: @project_release.marked_as_final, office_chief_name: @project_release.office_chief_name, office_chief_signed_date: @project_release.office_chief_signed_date, office_id: @project_release.office_id, project_id: @project_release.project_id, release_date: @project_release.release_date, release_no: @project_release.release_no, store_chief_name: @project_release.store_chief_name, store_chief_signed_date: @project_release.store_chief_signed_date, user_id: @project_release.user_id } }
