...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { address: @office.address, department: @office.department, email: @office.email, fax: @office.fax, gov: @office.gov, ministry: @office.ministry, office: @office.office, office_chief: @office.office_chief, phone: @office.phone, section_chief: @office.section_chief, store_chief: @office.store_chief, user_id: @office.user_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { address: @office.address, department: @office.department, email: @office.email, fax: @office.fax, gov: @office.gov, ministry: @office.ministry, office: @office.office, office_chief: @office.office_chief, phone: @office.phone, section_chief: @office.section_chief, store_chief: @office.store_chief, user_id: @office.user_id } }
