...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { demand_form: @controller.demand_form, mark_as_final: @controller.mark_as_final, purchase_order: @controller.purchase_order } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { demand_form: @controller.demand_form, mark_as_final: @controller.mark_as_final, purchase_order: @controller.purchase_order } }
