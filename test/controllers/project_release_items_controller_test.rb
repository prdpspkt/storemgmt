...
class ProjectReleaseItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_release_item" do
    assert_difference('ProjectReleaseItem.count') do
      post project_release_items_url, params: { project_release_item: { amount: @project_release_item.amount, code_no: @project_release_item.code_no, fiscal_year_id: @project_release_item.fiscal_year_id, item_classification_no: @project_release_item.item_classification_no, item_id: @project_release_item.item_id, item_register_page_no: @project_release_item.item_register_page_no, name_of_item_en: @project_release_item.name_of_item_en, name_of_item_ne: @project_release_item.name_of_item_ne, office_id: @project_release_item.office_id, project_item_id: @project_release_item.project_item_id, project_release_id: @project_release_item.project_release_id, quantity: @project_release_item.quantity, rate: @project_release_item.rate, release_from: @project_release_item.release_from, remarks: @project_release_item.remarks, specificaiton: @project_release_item.specificaiton, unit_en: @project_release_item.unit_en, unit_ne: @project_release_item.unit_ne, user_id: @project_release_item.user_id } }
    end
