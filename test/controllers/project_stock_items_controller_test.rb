...
class ProjectStockItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_stock_item" do
    assert_difference('ProjectStockItem.count') do
      post project_stock_items_url, params: { project_stock_item: { amount: @project_stock_item.amount, fiscal_year_id: @project_stock_item.fiscal_year_id, item_classification_no: @project_stock_item.item_classification_no, item_id: @project_stock_item.item_id, item_register_page_no: @project_stock_item.item_register_page_no, name_of_item_en: @project_stock_item.name_of_item_en, name_of_item_ne: @project_stock_item.name_of_item_ne, office_id: @project_stock_item.office_id, physical_status: @project_stock_item.physical_status, project_id: @project_stock_item.project_id, quantity: @project_stock_item.quantity, rate: @project_stock_item.rate, remarks: @project_stock_item.remarks, unit_en: @project_stock_item.unit_en, unit_ne: @project_stock_item.unit_ne, user_id: @project_stock_item.user_id } }
    end
