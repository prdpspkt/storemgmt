...
class ItemCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_category" do
    assert_difference('ItemCategory.count') do
      post item_categories_url, params: { item_category: { name: @item_category.name, office_id: @item_category.office_id, unit: @item_category.unit, user_id: @item_category.user_id } }
    end
  ...
  test "should update item_category" do
    patch item_category_url(@item_category), params: { item_category: { name: @item_category.name, office_id: @item_category.office_id, unit: @item_category.unit, user_id: @item_category.user_id } }
