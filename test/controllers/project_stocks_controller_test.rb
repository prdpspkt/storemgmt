...
class ProjectStocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_stock" do
    assert_difference('ProjectStock.count') do
      post project_stocks_url, params: { project_stock: { fiscal_year_id: @project_stock.fiscal_year_id, fy: @project_stock.fy, item_id: @project_stock.item_id, marked_as_final: @project_stock.marked_as_final, office_chief_designation: @project_stock.office_chief_designation, office_chief_name: @project_stock.office_chief_name, office_chief_signed_date: @project_stock.office_chief_signed_date, office_id: @project_stock.office_id, project_id: @project_stock.project_id, section_chief_degination: @project_stock.section_chief_degination, section_chief_name: @project_stock.section_chief_name, section_chief_signed_date: @project_stock.section_chief_signed_date, store_chief_designation: @project_stock.store_chief_designation, store_chief_name: @project_stock.store_chief_name, store_chief_signed_date: @project_stock.store_chief_signed_date, user_id: @project_stock.user_id } }
    end
