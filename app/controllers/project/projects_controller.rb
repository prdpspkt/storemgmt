class Project::ProjectsController < ProjectController
  ...
  # GET /projects/1.json
  def show
    @project_items408 = current(Project::ProjectItem).where(project_id: @project.id).where(item_classification_no: 408)
    @project_items407 = current(Project::ProjectItem).where(project_id: @project.id).where(item_classification_no: 407)
  ...
  def expense_item_register
    ...
    @items = current(Project::ProjectItem).where(project_id: @project.id).where(item_classification_no: 407)
  ...
  def non_expense_item_register
    ...
    @items = office(Project::ProjectItem).where(item_classification_no: 408)
    render 'item_register'
  end
