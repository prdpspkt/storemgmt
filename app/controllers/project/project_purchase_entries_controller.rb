class Project::ProjectPurchaseEntriesController < ProjectController
  ...
  def show
    ...
    @project_purchase_entry_items = @project_purchase_entry.project_purchase_entry_items.includes(:item)
    ...
    @items = @project_purchase_entry.purchase_entry.purchase_entry_items.includes(:item)
  end
