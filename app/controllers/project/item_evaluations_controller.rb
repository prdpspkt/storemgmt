class Project::ItemEvaluationsController < ProjectController
  ...
  def generate
    ...
    @item_evaluation = Project::ItemEvaluation.new
    @item_evaluation.item_evaluation_committee_id = item_evaluation_params[:item_evaluation_committee_id]
    @item_evaluation.report_name = item_evaluation_params[:name]
