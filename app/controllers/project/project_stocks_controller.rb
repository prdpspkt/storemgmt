class ProjectStocksController < ApplicationController
  ...
  private
    ...
    def project_stock_params
      params.require(:project_stock).permit(:fy, :store_chief_name, :store_chief_designation, :store_chief_sign_date, :section_chief_name, :section_chief_designation, :section_chief_signed_date, :project_chief_name, :project_chief_designation, :project_chief_signed_date, :project_id, :user_id, :fiscal_year_id)
    end
end
