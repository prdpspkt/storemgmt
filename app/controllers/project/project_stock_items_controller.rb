class ProjectStockItemsController < ApplicationController
  ...
  private
    ...
    def project_stock_item_params
      params.require(:project_stock_item).permit(:item_register_page_no, :item_classification_no, :name_of_item, :unit, :quantity, :rate, :amount, :physical_status, :remarks, :project_id, :project_item_id, :user_id, :fiscal_year_id)
    end
end
