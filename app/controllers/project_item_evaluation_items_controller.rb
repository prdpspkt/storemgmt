class ProjectItemEvaluationItemsController < ApplicationController
  before_action :set_office_item_evaluation_item, only: [:show, :edit, :update, :destroy]

  # GET /project_item_evaluation_items
  # GET /project_item_evaluation_items.json
  def index
    @office_item_evaluation_items = OfficeItemEvaluationItem.all
  end

  # GET /project_item_evaluation_items/1
  # GET /project_item_evaluation_items/1.json
  def show
  end

  # GET /project_item_evaluation_items/new
  def new
    @office_item_evaluation_item = OfficeItemEvaluationItem.new
  end

  # GET /project_item_evaluation_items/1/edit
  def edit
  end

  # POST /project_item_evaluation_items
  # POST /project_item_evaluation_items.json
  def create
  ...
  # PATCH/PUT /project_item_evaluation_items/1
  # PATCH/PUT /project_item_evaluation_items/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /project_item_evaluation_items/1
  # DELETE /project_item_evaluation_items/1.json
  def destroy
    @office_item_evaluation_item.destroy
    respond_to do |format|
      format.html { redirect_to project_item_evaluation_items_url, notice: 'Office item evaluation item was successfully destroyed.' }
