class OfficeEvaluationReportGenerator
  ...
  def perform(item_evaluation_id)
    ...
    pdf_path = Rails.root.join("pdfs", "#{@item_evaluation.office.id}", "#{@item_evaluation.fiscal_year.id}", "office-item-evaluation-report.pdf")
