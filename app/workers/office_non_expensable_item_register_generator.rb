class OfficeNonExpensableItemRegisterGenerator
  ...
  def perform office_id, fiscal_year_id, store_body_id
    ...
    items = Office::Item.where(office_id: office_id).where(item_classification_no: 408)
  ...
  def generate_and_save_pdf office, fiscal_year, items, cb
    ...
    generator = PdfGenerator.new('office/ledgers/non_expense_item_register.pdf', data, {orientation: "landscape"})
