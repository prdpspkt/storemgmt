json.set! :data do
  json.array! @rental_record_registers do |rental_record_register|
    ...
    json.url  "
              ...
              #{link_to 'Edit', edit_office_rental_record_register_path(rental_record_register)}
              #{link_to 'Destroy', office_rental_record_register, method: :delete, data: { confirm: 'Are you sure?' }}
              "
  end
end